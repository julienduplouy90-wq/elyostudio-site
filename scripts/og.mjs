...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  <defs>
    ...
    <linearGradient id="terre" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#C0663C"/>
      <stop offset="1" stop-color="#A2532E"/>
    </linearGradient>
    <radialGradient id="halo1" cx="0.5" cy="0.5" r="0.5">
      <stop offset="0" stop-color="#D9A06A" stop-opacity="0.55"/>
      <stop offset="1" stop-color="#D9A06A" stop-opacity="0"/>
    </radialGradient>
    <radialGradient id="halo2" cx="0.5" cy="0.5" r="0.5">
      <stop offset="0" stop-color="#1C2E57" stop-opacity="0.30"/>
      <stop offset="1" stop-color="#1C2E57" stop-opacity="0"/>
    </radialGradient>
  </defs>
  ...
  <g transform="translate(84 62) scale(1.3)">
    <path d="M17 43 A15 15 0 0 1 47 43 Z" fill="#C0663C"/>
    <g fill="none" stroke="#1C2E57" stroke-width="4.6" stroke-linecap="round">
      <path d="M32 12 V19"/>
  ...
  <text x="200" y="128" font-family="Georgia, 'Times New Roman', serif" font-size="42" font-weight="bold" fill="#111A2E">ElyoStudio</text>

  <!-- Titre -->
  <text x="88" y="286" font-family="Georgia, 'Times New Roman', serif" font-size="76" font-weight="bold" fill="#111A2E">Sites internet pour</text>
  <text x="88" y="374" font-family="Georgia, 'Times New Roman', serif" font-size="76" font-weight="bold" fill="#1C2E57">naturopathes</text>

  <text x="88" y="440" font-family="Helvetica, Arial, sans-serif" font-size="30" fill="#4A5567">Plus de rendez-vous grâce à un site clair et une fiche Google tenue.</text>
